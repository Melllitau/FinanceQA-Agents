...
files = [
  ("command-r7b_simple_eco.csv", "command-r7b_output_simple.json", "command-r7b_simple.txt"),
  ("deepseek-r1_14b_simple_eco.csv", "deepseek-r1_14b_output_simple.json", "deepseek-r1_14b_simple.txt"),
  ("deepseek-r1_32b_simple_eco.csv", "deepseek-r1_32b_output_simple.json", "deepseek-r1_32b_simple.txt"),
  ("gemma3_12b_simple_eco.csv", "gemma3_12b_output_simple.json", "gemma3_12b_simple.txt"),
  ("gemma3_27b_simple_eco.csv", "gemma3_27b_output_simple.json", "gemma3_27b_simple.txt"),
  ("qwen2.5_14b_simple_eco.csv", "qwen2.5_14b_output_simple.json", "qwen2.5_14b_simple.txt"),
  ("qwen2.5_32b_simple_eco.csv", "qwen2.5_32b_output_simple.json", "qwen2.5_32b_simple.txt"),
  ("qwq_simple_eco.csv", "qwq_output_simple.json", "qwq_simple.txt")
]
...
for file_name, file_json_name, file_txt_name in files:
  ...
  for rodada, rodada_corrected in rodadas:
    ...
    json_path = os.path.join(base_path, rodada_corrected, file_json_name)
